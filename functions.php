...
function jono_enqueue_styles() {
    ...
    wp_enqueue_script('custom-mobile', get_template_directory_uri() . '/assets/mobile.js' );
    wp_enqueue_script('custom-background', get_template_directory_uri() . '/assets/background.js','','',true);
